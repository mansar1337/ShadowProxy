...
function createSectionContent(section) {
  ...
  o = section.option(
    form.DummyValue,
    "_proxy_type_hint_url",
    _("Connection URL"),
    _("Paste one or multiple proxy links. One link per line is supported."),
  );
  o.depends("proxy_config_type", "url");

  o = section.option(
    form.DummyValue,
    "_proxy_type_hint_subscription",
    _("Subscription"),
    _("Use subscription URL and optional decoding/headers. Active node is selected automatically."),
  );
  o.depends("proxy_config_type", "subscription");

  o = section.option(
    form.DummyValue,
    "_proxy_type_hint_selector",
    _("Selector"),
    _("Provide several nodes and switch between them manually."),
  );
  o.depends("proxy_config_type", "selector");

  o = section.option(
    form.DummyValue,
    "_proxy_type_hint_urltest",
    _("URLTest"),
    _("Provide several nodes and automatically use the fastest by periodic checks."),
  );
  o.depends("proxy_config_type", "urltest");

  o = section.option(
    form.DummyValue,
    "_proxy_type_hint_outbound",
    _("Outbound Config"),
    _("Use full JSON outbound configuration for advanced custom setups."),
  );
  ...
  o = section.option(
    ...
    "subscription_url",
    _("Subscription URL"),
    _("HTTP(S) URL with a list of proxy links"),
  );
  o.depends("proxy_config_type", "subscription");
  ...
  o = section.option(
    ...
    _("Decode Base64"),
    _("Decode whole subscription response as Base64 before parsing"),
  );
  o.depends("proxy_config_type", "subscription");
  o.default = "0";
  o.rmempty = false;
  ...
  o = section.option(
    form.Flag,
    "subscription_custom_ua",
    _("Custom User-Agent"),
    _("Use ShadowProxy mobile-like HTTP headers when downloading subscription"),
  );
  o.depends("proxy_config_type", "subscription");
  o.default = "0";
  o.rmempty = false;
  ...
  o = section.option(
    ...
    _("How often to refresh subscription links"),
  );
  ...
  o.value("1d", _("Every 1 day"));
  o.default = "6h";
  o.depends("proxy_config_type", "subscription");

  o = section.option(
    form.ListValue,
    "subscription_ping_test_interval",
    _("Subscription Ping Test Interval"),
    _("How often to test latency and reselect the fastest node"),
  );
